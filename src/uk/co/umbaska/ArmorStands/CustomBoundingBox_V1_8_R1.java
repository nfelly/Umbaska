...
public class CustomBoundingBox_V1_8_R1 extends AxisAlignedBB {
    public CustomBoundingBox_V1_8_R1(Double d1, Double d2, Double d3, Double d4, Double d5, Double d6) {
