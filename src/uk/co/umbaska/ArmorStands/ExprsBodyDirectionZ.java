 ...
 */
public class ExprsBodyDirectionZ extends SimplePropertyExpression<Entity, Number> {
	@Override
	public Number convert(Entity ent) {
		if(ent == null)
			return null;
		return ((ArmorStand)ent).getBodyPose().getZ();
	}
	...
	public void change(Event e, Object[] delta, Changer.ChangeMode mode) {
		...
		if (mode == Changer.ChangeMode.SET){
            ...
            ((ArmorStand)ent).setBodyPose(as.getBodyPose().setZ(b.doubleValue()));
		}
