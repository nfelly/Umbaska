 ...
 */
public class EffSendTitle_V1_8_R1 extends Effect implements Listener {
    ...
    protected void execute(Event event) {
        ...
        for (Player p : playerlist) {
            ...
            TitleManager_V1_8_R1.sendSubTitle(p, newsubtitle);
            TitleManager_V1_8_R1.sendTitle(p, newtitle);
        }
