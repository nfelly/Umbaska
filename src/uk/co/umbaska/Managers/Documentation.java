...
public class Documentation {
	...
	private static File doc = new File(Main.getInstance().getDataFolder() + File.separator + "doc");
	...
	private static String multipleHead(Type type, String title){
		...
		if(type == Type.COLLECTION)
			for(String name : collections.keySet()) sb.append("<a href=" +'"' + "./" + name + ".html" + '"' + " class=" + '"' + "menu-link" + '"' + '>' + name + " </a> \n");
		else if(type == Type.OBJECT)
			for(String name : objects.keySet()) sb.append("<a href=" +'"' + "./" + name + ".html" + '"' + " class=" + '"' + "menu-link" + '"' + '>' + name + " </a> \n");
		String head = s
			.replace("{TITLE}", title)
	...
	private static void css(){
		InputStream css = Main.getInstance().getResource("doc/css/style.css");
		InputStream bebas = Main.getInstance().getResource("doc/css/BebasNeueRegular.ttf");
		InputStream kirvy = Main.getInstance().getResource("doc/css/Kirvy-Regular.otf");
		InputStream icon = Main.getInstance().getResource("doc/css/favicon.ico");
	...
	private static InputStream resource(String dir){
		return Main.getInstance().getResource(dir);
	}
